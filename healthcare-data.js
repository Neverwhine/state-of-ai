...
(function (root) {
  ...
  var SRC = {
    ...
    cms_rht:    'https://www.cms.gov/priorities/innovation/innovation-models',
    anthropic_health:'https://www.anthropic.com/news',
    ...
    kff_premiums:   'https://www.healthsystemtracker.org/',
    ...
    epa_deadline:   'https://www.cms.gov/priorities/key-initiatives/burden-reduction/interoperability/policies-and-regulations/cms-interoperability-and-prior-authorization-final-rule-cms-0057-f',
    ...
    jama_scribes:   'https://jamanetwork.com/journals/jamanetworkopen',
  ...
  var companies = [
    ...
    { id: 'co_epic',            name: 'Epic',                 group: 'leader', role: 'incumbent', layer_id: 'L1_hospital_ops', tag: 'Incumbent · EHR backbone',
      short_description: 'Leading US hospital EHR platform; AI agents embedded in scheduling, capacity and early-warning workflows.',
    ...
    { id: 'co_oracle_health',   name: 'Oracle Health',        group: 'leader', role: 'incumbent', layer_id: 'L1_hospital_ops', tag: 'Incumbent · #2 EHR',
      short_description: 'Oracle Health (Cerner) hospital EHR; Oracle AI Agent automates clinical workflows on Millennium.',
      money_pool_ids: ['pool_it_data','pool_provider_admin'],
      destination_ids: ['dest_hospital'],
    ...
    { id: 'co_qventus',         name: 'Qventus',              group: 'leader', role: 'ai-native', layer_id: 'L1_hospital_ops', tag: 'AI-native leader',
      short_description: 'AI surgical scheduling and capacity automation for health systems.',
    ...
    { id: 'co_qualified',       name: 'Qualified Health',     group: 'dvc',    role: 'dvc',       layer_id: 'L1_hospital_ops', tag: 'DVC portfolio · Hospital AI OS',
      short_description: 'Enterprise AI governance and deployment operating system for health systems.',
      money_pool_ids: ['pool_it_data','pool_provider_admin'],
      destination_ids: ['dest_hospital'],
    ...
    { id: 'co_optum_care',      name: 'Optum Care',           group: 'leader', role: 'incumbent', layer_id: 'L2_physician_groups', tag: 'Incumbent · Largest physician employer',
      short_description: 'Large US physician employer within UHG’s vertically integrated payer-provider system.',
    ...
    { id: 'co_privia',          name: 'Privia Health',        group: 'leader', role: 'ai-native', layer_id: 'L2_physician_groups', tag: 'AI-native leader · Physician enablement',
      short_description: 'Technology-enabled physician platform using generative AI to reduce administrative work.',
    ...
    { id: 'co_agilon',          name: 'Agilon Health',        group: 'leader', role: 'drawer',    layer_id: 'L2_physician_groups', tag: 'Drawer · MA risk enabler',
      short_description: 'Transforms independent primary-care practices into full-risk Medicare Advantage providers.',
      money_pool_ids: ['pool_clinical_labor','pool_payer_admin'],
      destination_ids: ['dest_physician'],
    ...
    { id: 'co_nuance_dax',      name: 'Nuance DAX',           group: 'leader', role: 'incumbent', layer_id: 'L3_ambient_doc', tag: 'Incumbent · Microsoft DAX Copilot',
      short_description: 'Enterprise ambient documentation with deep Epic integration via Microsoft Dragon Copilot.',
    ...
    { id: 'co_abridge',         name: 'Abridge',              group: 'leader', role: 'ai-native', layer_id: 'L3_ambient_doc', tag: 'AI-native leader',
      short_description: 'Clinical language models with deep Epic integration and a nursing-scribe collaboration with Mayo.',
      money_pool_ids: ['pool_clinical_labor','pool_provider_admin'],
      destination_ids: ['dest_physician','dest_hospital'],
      process_step_ids: ['C4','C5','F3'],
      ai_surface_ids: ['ai_scribes_copilots'],
    ...
    { id: 'co_ambience',        name: 'Ambience Healthcare',  group: 'leader', role: 'drawer',    layer_id: 'L3_ambient_doc', tag: 'Drawer · Specialty-tuned scribe',
      short_description: 'Enterprise ambient documentation with specialty-tuned models and major health-system deployments.',
      money_pool_ids: ['pool_clinical_labor'],
      destination_ids: ['dest_physician','dest_hospital'],
      process_step_ids: ['C4','C5'],
      ai_surface_ids: ['ai_scribes_copilots'],
    ...
    { id: 'co_uptodate',        name: 'UpToDate',             group: 'leader', role: 'incumbent', layer_id: 'L4_cds_evidence', tag: 'Incumbent · Wolters Kluwer',
      short_description: 'Large point-of-care clinical decision-support platform with UpToDate Expert AI.',
      money_pool_ids: ['pool_clinical_labor','pool_it_data'],
      destination_ids: ['dest_physician','dest_hospital'],
    ...
    { id: 'co_openevidence',    name: 'OpenEvidence',         group: 'leader', role: 'ai-native', layer_id: 'L4_cds_evidence', tag: 'AI-native leader',
      short_description: 'Clinical answer engine with an AMA partnership and a DeepConsult research agent.',
      money_pool_ids: ['pool_clinical_labor','pool_it_data'],
      destination_ids: ['dest_physician','dest_hospital'],
      process_step_ids: ['C2','C5'],
      ai_surface_ids: ['ai_scribes_copilots'],
    ...
    { id: 'co_evidencecare',    name: 'EvidenceCare',         group: 'leader', role: 'drawer',    layer_id: 'L4_cds_evidence', tag: 'Drawer · EHR-embedded CDS',
      short_description: 'EHR-embedded clinical decision support through its BetterCare platform.',
      money_pool_ids: ['pool_provider_admin','pool_clinical_labor'],
      destination_ids: ['dest_hospital'],
    ...
    { id: 'co_aidoc',           name: 'Aidoc',                group: 'leader', role: 'ai-native', layer_id: 'L5_imaging', tag: 'AI-native leader',
      short_description: 'AI operating system for radiology spanning worklists, analysis and care coordination.',
    ...
    { id: 'co_r1rcm',           name: 'R1 RCM',               group: 'leader', role: 'incumbent', layer_id: 'L7_provider_rcm', tag: 'Incumbent · Health-system RCM',
      short_description: 'End-to-end RCM outsourcing for health systems with AI-augmented coding and claims workflows.',
      money_pool_ids: ['pool_provider_admin'],
    ...
    { id: 'co_waystar',         name: 'Waystar',              group: 'leader', role: 'drawer',    layer_id: 'L7_provider_rcm', tag: 'Drawer · Clearinghouse + RCM',
      short_description: 'AI-powered claims clearinghouse and RCM software; public since 2024.',
      money_pool_ids: ['pool_provider_admin'],
      destination_ids: ['dest_hospital','dest_physician'],
    ...
    { id: 'co_fathom',          name: 'Fathom',               group: 'leader', role: 'drawer',    layer_id: 'L7_provider_rcm', tag: 'Drawer · Autonomous coding',
      short_description: 'Autonomous medical coding with a strategic investment from CVS Health Ventures.',
      money_pool_ids: ['pool_provider_admin'],
      destination_ids: ['dest_hospital','dest_physician'],
      process_step_ids: ['F3'],
      ai_surface_ids: ['ai_admin_rcm'],
    ...
    { id: 'co_cedar',           name: 'Cedar',                group: 'leader', role: 'incumbent', layer_id: 'L7b_patient_billing', tag: 'Incumbent · Patient finance',
      short_description: 'AI patient financial-engagement and payments platform.',
      money_pool_ids: ['pool_provider_admin'],
      destination_ids: ['dest_hospital','dest_physician'],
    ...
    { id: 'co_collectly',       name: 'Collectly',            group: 'dvc',    role: 'ai-native', layer_id: 'L7b_patient_billing', tag: 'DVC portfolio · AI patient billing',
      short_description: 'AI patient billing and collection through the Billie voice and chat agent, with bidirectional Epic integration. Company-reported operating metrics were removed because they were not independently audited.',
      money_pool_ids: ['pool_provider_admin'],
      destination_ids: ['dest_hospital','dest_physician'],
      process_step_ids: ['F6','F7'],
      ai_surface_ids: ['ai_financial_engagement'],
    ...
    { id: 'co_surescripts',     name: 'Surescripts',          group: 'leader', role: 'incumbent', layer_id: 'L8_denials_prior_auth', tag: 'Incumbent · ePA network',
      short_description: 'Electronic prior authorization and touchless workflow network for pharmacy.',
    ...
    { id: 'co_cohere',          name: 'Cohere Health',        group: 'leader', role: 'ai-native', layer_id: 'L8_denials_prior_auth', tag: 'AI-native leader · Payer-side',
      short_description: 'Clinically grounded payer-side prior-authorization automation.',
    ...
    { id: 'co_infinitus',       name: 'Infinitus',            group: 'leader', role: 'drawer',    layer_id: 'L8_denials_prior_auth', tag: 'Drawer · Voice AI for PA calls',
      short_description: 'Voice AI agents for prior-authorization phone workflows used by pharma and specialty pharmacy teams.',
      money_pool_ids: ['pool_provider_admin','pool_payer_admin'],
      destination_ids: ['dest_rx'],
      process_step_ids: ['F2'],
      ai_surface_ids: ['ai_admin_rcm'],
    ...
    { id: 'co_arcadia',         name: 'Arcadia',              group: 'leader', role: 'ai-native', layer_id: 'L10_vbc_ma', tag: 'AI-native leader',
      short_description: 'Population-health and value-based-care analytics for health systems and accountable-care organizations.',
    ...
    { id: 'co_scriptpro',       name: 'ScriptPro',            group: 'leader', role: 'drawer',    layer_id: 'L11_retail_pharmacy', tag: 'Drawer · Robotic dispensing',
      short_description: 'Robotic pharmacy-dispensing systems designed for high-throughput, long-lived deployments.',
    ...
    { id: 'co_realrx',          name: 'RealRx',               group: 'leader', role: 'drawer',    layer_id: 'L12_pbm', tag: 'Drawer · Specialty AI optimization',
      short_description: 'Regional PBM using AI to direct specialty fills to lower-net-cost pharmacies.',
      money_pool_ids: ['pool_pharma_channel','pool_drugs_biologics'],
      destination_ids: ['dest_rx'],
      process_step_ids: ['F2'],
      ai_surface_ids: ['ai_admin_rcm'],
    ...
    { id: 'co_alphasense',      name: 'AlphaSense',           group: 'leader', role: 'ai-native', layer_id: 'L13_pharma_intel', tag: 'AI-native leader · CI search',
      short_description: 'AI-powered competitive-intelligence search used by pharmaceutical teams.',
      outside_nhe: true,
      money_pool_ids: ['pool_drugs_biologics','pool_it_data'],
      destination_ids: [],
      process_step_ids: [],
    ...
    { id: 'co_bioptic',         name: 'Bioptic',              group: 'dvc',    role: 'dvc',       layer_id: 'L13_pharma_intel', tag: 'DVC portfolio · Pharma BD&L AI',
      short_description: 'AI engine for pharmaceutical business development that monitors global technical and patent sources.',
      outside_nhe: true,
      money_pool_ids: ['pool_drugs_biologics','pool_it_data'],
      destination_ids: [],
      process_step_ids: [],
    ...
    { id: 'co_insilico',        name: 'Insilico Medicine',    group: 'leader', role: 'drawer',    layer_id: 'L14_drug_discovery', tag: 'Drawer · End-to-end AI pipeline',
      short_description: 'AI-designed IPF drug candidate in Phase IIa development.',
      outside_nhe: true,
      money_pool_ids: ['pool_drugs_biologics'],
      destination_ids: [],
      process_step_ids: [],
    ...
    { id: 'co_dexcom',          name: 'Dexcom',               group: 'leader', role: 'incumbent', layer_id: 'L16_consumer_prevention', tag: 'Incumbent · CGM',
      short_description: 'Major continuous-glucose-monitoring platform; Stelo offers OTC monitoring with Oura integration.',
      money_pool_ids: ['pool_supplies_devices'],
      destination_ids: ['dest_dme'],
      process_step_ids: ['C8','P2'],
      ai_surface_ids: ['ai_prevention'],
    ...
    { id: 'co_oura',            name: 'Oura',                 group: 'leader', role: 'ai-native', layer_id: 'L16_consumer_prevention', tag: 'AI-native leader',
      short_description: 'Smart ring and biometrics platform with metabolic and continuous-glucose-monitor integrations.',
      money_pool_ids: ['pool_supplies_devices','pool_it_data'],
      destination_ids: ['dest_dme'],
      process_step_ids: ['C8','P2'],
      ai_surface_ids: ['ai_prevention'],
    ...
    { id: 'co_levels',          name: 'Levels Health',        group: 'leader', role: 'drawer',    layer_id: 'L16_consumer_prevention', tag: 'Drawer · CGM + AI metabolic',
      short_description: 'Continuous-glucose monitoring with AI metabolic coaching and real-time food-response tracking.',
      money_pool_ids: ['pool_supplies_devices','pool_it_data'],
      destination_ids: ['dest_dme'],
    ...
    { id: 'co_doctronic',       name: 'Doctronic',            group: 'dvc',    role: 'dvc',       layer_id: 'L17_virtual_pcp', tag: 'DVC portfolio · Direct-pay AI doctor',
      short_description: 'Multi-agent AI physician consultation validated with UCSF. In July 2026 the company acquired Summer Health, adding pediatric-care data and enterprise distribution; promotional encounter and pricing metrics were removed because they were company-disclosed and unaudited.',
      money_pool_ids: ['pool_clinical_labor','pool_provider_admin'],
      destination_ids: ['dest_physician'],
    ...
    { id: 'co_pearl_dental',    name: 'Pearl',                group: 'leader', role: 'ai-native', layer_id: 'L18_dental', tag: 'AI-native leader · Global dental AI',
      short_description: 'Dental AI platform with FDA-cleared imaging products and an ADA strategic investment.',
      money_pool_ids: ['pool_supplies_devices','pool_clinical_labor'],
      destination_ids: ['dest_dental'],
      process_step_ids: ['C5'],
      ai_surface_ids: ['ai_diagnostics'],
    ...
    { id: 'co_optum_behavioral',name: 'Optum Behavioral',     group: 'leader', role: 'incumbent', layer_id: 'L19_mental_health', tag: 'Incumbent · MBHO',
      short_description: 'Large managed behavioral-health organization serving employers and health plans.',
      money_pool_ids: ['pool_clinical_labor','pool_payer_admin'],
      destination_ids: ['dest_other_professional'],
    ...
    { id: 'co_spring_health',   name: 'Spring Health',        group: 'leader', role: 'ai-native', layer_id: 'L19_mental_health', tag: 'AI-native leader',
      short_description: 'Employer mental-health benefits platform using AI-assisted matching across international markets.',
      money_pool_ids: ['pool_clinical_labor'],
      destination_ids: ['dest_other_professional'],
      process_step_ids: ['C2','C3','C6'],
      ai_surface_ids: ['ai_patient_access','ai_prevention'],
    ...
    { id: 'co_lyra',            name: 'Lyra Health',          group: 'leader', role: 'drawer',    layer_id: 'L19_mental_health', tag: 'Drawer · Triage + therapy',
      short_description: 'AI-enhanced behavioral-health triage and matching with clinical oversight.',
      money_pool_ids: ['pool_clinical_labor'],
      destination_ids: ['dest_other_professional'],
      process_step_ids: ['C2','C3','C6'],
      ai_surface_ids: ['ai_patient_access'],
    ...
    { id: 'co_resmed',          name: 'ResMed',               group: 'leader', role: 'incumbent', layer_id: 'L21_sleep', tag: 'Incumbent · CPAP + AirView',
      short_description: 'CPAP platform with AirView remote monitoring and AI-powered adherence management.',
      money_pool_ids: ['pool_supplies_devices'],
      destination_ids: ['dest_dme'],
      process_step_ids: ['C8','P2'],
      ai_surface_ids: ['ai_prevention'],
    ...
    { id: 'co_eight_sleep',     name: 'Eight Sleep',          group: 'leader', role: 'ai-native', layer_id: 'L21_sleep', tag: 'AI-native leader',
      short_description: 'AI-powered smart mattress company pursuing regulated sleep-health applications.',
      money_pool_ids: ['pool_supplies_devices'],
      destination_ids: ['dest_dme'],
      process_step_ids: ['C8','P2'],
      ai_surface_ids: ['ai_prevention'],
    ...
    { id: 'co_big_health',      name: 'Big Health (SleepioRx)',group: 'leader', role: 'drawer',   layer_id: 'L21_sleep', tag: 'Drawer · FDA-cleared PDT',
      short_description: 'FDA-cleared prescription digital therapeutic for chronic insomnia using CBT-I.',
  ...
  var takeaways = [
    { title: 'AI follows incentives — and in fee-for-service it can raise efficiency AND total spend',
      copy: 'This is the section\'s thesis. Independent studies show ambient documentation can reduce documentation burden, while health plans project a 9% group / 8.5% individual 2027 medical cost trend and identify provider documentation and coding tools as material inflators. PwC\'s mechanism is not more services but "changes in severity, mix and amount per claim." Efficiency is not a savings thesis unless someone bears risk.' },
    ...
    { title: 'Admin AI is an arms race — and the admin number is market size, not savings', copy: 'The CMS NHE admin line is ~$371B; total addressable admin drag (provider billing + payer ops + clinical documentation) is ~$800-900B per Commonwealth Fund. Prior auth, coding, claims, and RCM are the highest-ROI surfaces, and automation on one side triggers automation on the other — WISeR survived a Senate vote to halt it (tally not printed — unverified) and ePA becomes mandatory Jan 1, 2027. But a systematic review of 98 economic evaluations found only 36% showed a clear economic preference for AI, with zero evaluations of generative AI at all. Treat the drag as the size of the prize, never as the size of the saving.' },
    { title: 'Two gates, not one: reimbursement decides what gets bought, liability decides what gets deployed', copy: 'The NOHARM benchmark found omissions dominated harmful errors (not peer-reviewed; disputed), OpenAI was sued for the unauthorized practice of medicine one day before Health in ChatGPT launched, and a healthcare AI vendor reported a major multi-system breach. Courts have not yet allocated liability among doctor, hospital and vendor.' },
    { title: 'Two clocks, not one: admin 2–4 years, clinical autonomy 10–15 years', copy: 'Admin moves on regulatory deadlines such as the Jan 1, 2027 ePA mandate. Clinical autonomy moves on evidence, liability and regulated deployment rather than the size of the pilot pipeline.' },
    ...
    { title: 'The data layer is shared — and the consumer front door is now a frontier lab', copy: 'Care, payment, prevention, research and admin all compete over the same records, claims, labs, devices and workflow data. OpenAI now connects Apple Health, supported hospital records, One Medical and Function Health inside ChatGPT. The exact user and substitution figures previously printed here were removed after source audit.' },
    { title: 'Vendor metrics are company-disclosed; independent evidence is narrower', copy: 'Read no-human-in-the-loop, penetration and workflow-savings claims as vendor-reported until audited. Independent studies support the direction of lower documentation burden, but measured effect sizes vary by workflow and adoption.' }
  ];
  ...
  var loopCallouts = [
    ...
    { id: 'cl_cms_rht',
      ...
      source_url: 'https://www.cms.gov/priorities/innovation/innovation-models' },
    { id: 'cl_claude_health',
      group: 'pg_financial',
    ...
    { id: 'cl_2027_trend',
      ...
      body: 'PwC\'s "Medical Cost Trend: Behind the Numbers 2027" projects a 9% group and 8.5% individual medical cost trend for 2027 and identifies provider AI documentation and coding tools as an important new inflator. About 70% of surveyed plans put AI tools in their top three cost drivers; about 20% call AI the single biggest. PwC\'s mechanism is not more services but "changes in severity, mix and amount per claim." We remove the separate ACA median-rate figure because it could not be confirmed directly from the cited tracker.',
    ...
    { id: 'cl_coding_intensity',
      ...
      stat: 'Same care · higher documented severity',
      body: 'Payers and health-system researchers report that AI-assisted documentation can increase coding intensity and billing units even when the underlying care does not change. We retain the mechanism and remove the exact maternity-code and dollar figures because the underlying payer publication could not be obtained during the Aug 4 audit.',
    ...
    { id: 'cl_consumer_front_door',
      ...
      body: 'OpenAI launched "Health in ChatGPT" in July 2026. Users can connect Apple Health, supported US hospital medical records, One Medical and Function Health with separate controls for connected data. We retain the product and consent architecture from the first-party release and remove the model-comparison, conversation-share and daily-user figures that could not be independently reproduced during the audit. Consumer AI is now a live healthcare distribution channel.',
    ...
    { id: 'cl_two_clocks',
      ...
      body: 'A single "10–15 year transformation horizon" is unfalsifiable. ADMIN MOVES ON REGULATORY DEADLINES — 2 to 4 years: CMS\'s ePA standard is mandatory Jan 1, 2027. CLINICAL AUTONOMY MOVES ON EVIDENCE, LIABILITY AND REGULATED DEPLOYMENT — 10 to 15 years. We remove the vendor-survey adoption percentages and absolute FDA count that could not be verified against accessible primary material during the audit.',
    ...
    { id: 'cl_fda_precision',
      ...
      stat: 'Designation is not clearance',
      body: 'Any copy implying that generative-AI clinical tools are broadly approved is misleading. Breakthrough Device Designation is an expedited review status, not market clearance. The audit could not independently reproduce the absolute count of marketed generative-AI devices or the named designation details, so those figures are not printed.',
    ...
    { id: 'cl_scribe_roi_band',
      ...
      stat: 'Documentation burden falls · time is redirected',
      body: 'Independent studies generally find lower documentation burden and more clinician attention available for the patient, but the measured effect varies by setting and adoption intensity. The Aug 4 audit could not retrieve the primary publications supporting the exact minute and percentage estimates previously printed, so those values have been removed.',
    ...
    { id: 'cl_nhs_counterfactual',
      ...
      stat: 'National programme · published benefit case',
      body: 'NHS England published a multi-year AI and digital programme spanning triage, ambient documentation, shared records and staff productivity. We retain the single-payer counterfactual and remove the investment, benefit and time-saved figures because they could not be reconciled consistently across the cited materials.',
    ...
    { id: 'cl_hc_funding_regime',
      ...
      stat: 'Fewer deals · larger concentration',
      body: 'Healthcare AI financing concentrated into fewer, larger rounds during 2026. We remove the exact quarter, deal-count and concentration figures because the underlying PitchBook report could not be accessed during the audit.',
  ...
  var sources = [
    ...
    { label: 'Peterson-KFF Health System Tracker — proposed 2027 ACA rate filings (median figure not printed — unverified)', url: SRC.kff_premiums },
    { label: 'Kocher, Zhao & Duffy, NEJM Catalyst via USC Schaeffer', url: SRC.kocher_nejm },
    { label: 'STAT — Senate fails to halt the WISeR prior-auth pilot', url: SRC.wiser_stat },
    ...
    { label: 'CMS — Interoperability and Prior Authorization final rule', url: 'https://www.cms.gov/priorities/key-initiatives/burden-reduction/interoperability/policies-and-regulations/cms-interoperability-and-prior-authorization-final-rule-cms-0057-f' },
    ...
    { label: "King's College London via The Register — consumer substitution signal", url: SRC.kcl_substitution },
    { label: 'Microsoft + Health Management Academy — adoption remains pilot-heavy', url: SRC.ms_hma_agents },
    { label: 'CRS IF13245 — generative-AI device policy and regulatory status', url: SRC.crs_genai_fda },
    { label: 'Aidoc — FDA Breakthrough Device Designation for genAI radiology reports', url: SRC.aidoc_bdd },
    { label: 'NHS England — national AI and digital programme', url: SRC.nhs_10b },
    ...
    { label: 'Fierce Healthcare — digital health financing context', url: SRC.fierce_h1 },
    { label: "Becker's — healthcare AI vendor breach", url: SRC.xsolis_breach },
